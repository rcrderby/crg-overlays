...
<details>
  ...
  ***config*** **Section**
  ...
  | `titleBannerBackgroundColor` | Title banner background color, or `transparent` | string | `#666666`[^3] | :white_check_mark: |
  | `titleBannerBackgroundColor` | Title banner text/foreground color, or `transparent` | string | `#ffffff`[^3] | :white_check_mark: |
